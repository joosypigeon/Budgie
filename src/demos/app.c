        ...
        BeginDrawing();
            ...
            BeginMode3D(camera);
                ...
                BeginShaderMode(shader);
                    ...
                    if(key) keyboard(key);
                    if(IsMouseButtonPressed(MOUSE_LEFT_BUTTON)) mouseButtonPressed(MOUSE_LEFT_BUTTON);
                    displayDemo();
                EndShaderMode();
            ...
            displayInfo(Y + 4*d, d); // call demo function
